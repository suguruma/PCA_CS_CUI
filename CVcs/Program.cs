...
namespace CVcs
{
    ...
    {
        public const int LEARNING_DATA = 184;
        public const int EIGEN_DATA = 184; // LEARNING_DATA <= EIGEN_DATA であること
        public const int RECON_DATA = 184; // EIGEN_DATA <= RECON_DATA であること
